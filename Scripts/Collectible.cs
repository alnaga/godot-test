...
public partial class Collectible : Area2D
{
    ...
    {
        Collected = true;
        player.Score += Value; // Or call a method on player
        QueueFree();
        GD.Print("Player collected the collectible!");
    }
}